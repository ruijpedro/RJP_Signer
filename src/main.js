...
app.innerHTML = `
  ...
  <main>
    ...
    <section class="hero">
      <span class="eyebrow">V1.4.4 · CARTÃO DE CIDADÃO + CHAVE MÓVEL DIGITAL</span>
    ...
    <section class="notice"><strong>DWF / PDF</strong><span>A análise está disponível. A arquitetura V1.4.4 fica preparada para os dois métodos também nestes formatos; os motores DWF clássico e PAdES/PDF-A continuam desativados até validação.</span></section>
  ...
  <footer>RJP Signer V1.4.4 · DWF / DWFx / PDF / PDF-A</footer>`;
